 ...
 shadow-sm z-50">
                <nav className="px-4 py-3 flex items-center justify-between">
                    ...
                    <div className="flex items-center space-x-3 text-gray-900">
                        ...
                        <Link to="/login"><Link to="/login"><FaUserCircle className="text-xl"/></Link></Link>
                    </div>
                </nav>
            </header>
                        ...
                        <form onSubmit={handleSubmit}>
                            <div className="mb-4">
                                <input
                                    ...
                                    className={`w-full p-3 border ${errors.companyName ? 'border-red-500' : 'border-border-grey'} rounded-md focus:ring-gray-800 focus:border-gray-800 transition-all`}
                                />
                            ...
                            <div className="mb-4">
                                <input
                                    ...
                                    onChange={handleChange}
                                    className={`w-full p-3 border ${errors.fullName ? 'border-red-500' : 'border-border-grey'} rounded-md focus:ring-gray-800 focus:border-gray-800 transition-all`}
                                />
                            ...
                            <div className="mb-6 flex items-center">
                                ...
                                <label htmlFor="acceptTerms" className="text-sm text-gray-900">
                                    J'accepte les <Link to="/terms" className="text-gray-800 hover:underline">Conditions Générales d'Utilisation</Link> et la <Link to="/privacy" className="text-gray-800 hover:underline">Politique de Confidentialité</Link>
                                </label>
                            </div>
